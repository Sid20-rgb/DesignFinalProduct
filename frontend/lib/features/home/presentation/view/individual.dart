  ...
  Future<void> fetchBlogContent() async {
    try {
      ...
      final response = await http.get(
        ...
        headers: {
          'Authorization':
              'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1ODk5YjdhOWQwNTJiODI4YjQ1ZjZhZSIsInVzZXJuYW1lIjoidGV0c3RpbmdtIiwiZW1haWwiOiJ0ZXN0aW5nQGdtYWlsLmNvbSIsImlhdCI6MTcwMzUxNzQ0NywiZXhwIjoxNzA2MTA5NDQ3fQ.lVuzwNPNbowEO8dC_wFZEPPzJDqexivaqd7teQoSkuI',
        },
      );
