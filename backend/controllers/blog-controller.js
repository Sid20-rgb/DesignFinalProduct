...
//     const blogData = {
//       ...req.body,
//       user: user, // it was user: user.id before, Assign the user's ID to the blog's user field
//     };
...
const searchUsers = (req, res, next) => {
  const { query } = req.query; // Make sure 'query' is correctly extracted from the request query
